...
public class EntryIntoStorage extends JPanel{
    ...
    public void View(){
            ...
            bonLivraisonTextField.setPreferredSize(new Dimension(300, 50));
            ...
            idProduitTextField.setPreferredSize(new Dimension(300, 50));
            ...
            nomProduitTextField.setPreferredSize(new Dimension(300, 50));
